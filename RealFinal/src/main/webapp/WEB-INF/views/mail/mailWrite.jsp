	        ...
	        if(files != null && files != undefined){
		        ...
		        //	console.log("hey7878"+fileSize);
		                ...
		                */
		                ...
		                arrLength = file_arr.length; // 수정필 :이거 아니고 나중에 tr id='' 조회해서 name 추가해 야할듯? 아닐 수도 ㅋ 
		                html += 
		                    "<tr id='fileList' >" + 
		                        "<td>" + 
		                        	"<div class='fileName'>" + 
					...
					$.ajax({
		                ...
		                //	console.log(json.n);
		                	if(json.n == 0){
    	                	 ...
    	                	 //	$("input:hidden[name='incomeEmpId']").val(item.empId);
	...
	<form name="mailFrm" enctype="multipart/form-data">
		...
		<div class="content_title" id="content_title">
			...
			<fieldset>
				...
				<!-- 수정필 ... 미리보기 안 할 거면 지워
				<span class="detail_select">
					<a href="javascript:void(0)" onclick="mailPreview();">미리보기</a>
				</span> -->
				<span class="detail_select">
