...
<div id="contents">
	<div class="content_title">
		...
		<span class="detail_select js-approval-lists-second-type hide" id="countCheckApprovalLists" style="display: none;">0</span>
						...
						<c:if test="${not empty requestScope.ingList}">
							...
							<c:forEach var="approvalVo" items="${requestScope.ingList}">
								...
								<tr class="tableData">
									<td>
										<label>
											<input type="checkbox" class="js-checkbox-approval-lists" value="211537">
										</label>
									</td>
									<td class="docu-num" data-href="수정필">
										<div title="${approvalVo.fk_approvalId}">${approvalVo.fk_approvalId}</div>
									</td>
									<td class="new-open-window resizable-pdl-0 resizable-pdr-0" data-href="수정필" id="sizzle1702134339574">
									...
									<td class="docu-type" data-href="수정필">${approvalVo.procedureType}</td>
									<td class="docu-result" data-href="수정필">
