							...
							<form name="checkFrm">
								<c:forEach var="approvalVo" items="${requestScope.ingList}">
									...
									<tr>
										...
										<td class="new-open-window resizable-pdl-0 resizable-pdr-0 tableData" id="">
											<span class="icon h_new span-new-link" style="margin-top: 0px;"></span>
										</td>
										...
										<td title="${approvalVo.draftDay}" class="tableData">${fn:substring(approvalVo.draftDay, 0, fn:indexOf(approvalVo.draftDay, " "))}</td>
										<td class="docu-type tableData">${approvalVo.procedureType}</td>
										<td class="docu-result tableData">
