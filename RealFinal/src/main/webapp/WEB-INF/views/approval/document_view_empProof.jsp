...
$(document).ready(function() {
	...
	$(document).on("mousedown", "ul.application_autocomplete li", function() {
		...
		if(isExist){
			...
			html += `<li class="js-approval-line-setting applicationLine-li unsortable" id="processLineSettingEmpId_` + empId +`" style="cursor: auto;"><span>` + empName + `<span class="icon file_delete js-approval-line-setting-delete"></span></span><span style="display:none;">` + positionName + `</span></li>`;
