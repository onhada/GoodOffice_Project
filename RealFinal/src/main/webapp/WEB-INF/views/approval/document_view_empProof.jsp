...
$(document).ready(function() {
	...
	$(document).on("mousedown", "ul.application_autocomplete li", function() {
		...
		if(isExist){
			...
			html += `<li class="js-approval-line-setting applicationLine-li unsortable" id="processLineSettingEmpId_` + empId +`" user_no="수정필" node_id="수정필" old_new="old" style="cursor: auto;"><span>` + empName + `<span class="icon file_delete js-approval-line-setting-delete"></span></span><span style="display:none;">` + positionName + `</span></li>`;
...
<div id="contents">
	...
	<!-- <input type="hidden" name="approval_document_no" value="30300">
	<input type="hidden" name="approval_first_line" value="3848">
	<input type="hidden" name="approval_second_line" value="3847">
	...
	<input type="hidden" name="approval_list_view" value="/tempfinal.onhiworks.com/approval/document/box/all/?&amp;list_mode=W"> -->
			...
			<div class="approval-wrap write view">
				...
				<div class="docu-common-wrap">
					...
					<div class="contents after">
						<table align="center" style="border: 0px none rgb(0, 0, 0); width: 606px; height: 349px; font-size: 16px; word-break: break-all; border-collapse: separate;" border="1" cellspacing="0" cellpadding="0">
							<tbody>
								<tr>
									<td colspan="3" scope="" style="border: 0px none rgb(0, 0, 0); width: 1092px; height: 20px;">
										<p style="font-family: &amp; quot; 맑은 고딕&amp;quot;; line-height: 1.6; margin-top: 0px; margin-bottom: 0px; font-size: 16px;">
											<span style="font-size: 20px;">
												<b>OO 주식회사</b>
											</span>
										</p>
									</td>
									<td rowspan="3" colspan="2" scope="" style="border: 0px none rgb(0, 0, 0); width: 10px; height: 37px; text-align: right; vertical-align: top;">
										<p style="line-height: 1.2; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
											<span style="font-size: 12px; font-family: &amp; quot;맑은 고딕&amp;quot;;">&nbsp;</span>
											<span style="font-size: 24px;">
												<b>&nbsp;<img src="<%= ctxPath %>/resources/image/dbunit_logo.png" border="0" style="border: 0px solid rgb(0, 0, 0); width: 120px; height: 30px; margin: 0px;"></b>
											</span>
										</p>
										<p style="line-height: 1.2; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
											<span style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 12px;">&nbsp;</span>
										</p>
									</td>
								</tr>
								<tr>
									<td colspan="3" scope="" style="border: 0px none rgb(0, 0, 0); width: 1092px; height: 10px;">
										<p style="line-height: 1.2; font-family: &amp; quot; 맑은 고딕&amp;quot;; margin-top: 0px; margin-bottom: 0px; font-size: 16px;">
											<span style="font-size: 12px; font-family: &amp; quot;맑은 고딕&amp;quot;;">OO도 OO시 OO구 OO로 123 OO빌딩 1234호</span>
										</p>
									</td>
								</tr>
								<tr>
									<td colspan="3" scope="" style="border: 0px none rgb(0, 0, 0); width: 1092px; height: 10px;">
										<p style="line-height: 1.2; font-family: &amp; quot; 맑은 고딕&amp;quot;; margin-top: 0px; margin-bottom: 0px; font-size: 16px;">
											<span style="font-size: 12px; font-family: &amp; quot;맑은 고딕&amp;quot;;">Tel. 1234-5678&nbsp; Fax. 1234-0987&nbsp; www.abc.com</span>
										</p>
									</td>
								</tr>
								<tr>
									<td colspan="5" scope="" style="border: 0px none rgb(0, 0, 0); width: 600px; height: 10px;">
										<p style="line-height: 1.6; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
											<br>
										</p>
									</td>
								</tr>
								...
								<tr>
									<td colspan="5" scope="" style="border: 0px none rgb(0, 0, 0); width: 867px; height: 20px;">
										<p style="text-align: center; line-height: 1.6; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
								...
								<tr>
									<td scope="" style="border: 0px none rgb(0, 0, 0); width: 66px; height: 20px;">
										<p style="text-align: justify; line-height: 1.6; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">이&nbsp; &nbsp; &nbsp;름</p>
									</td>
									<td scope="" style="border: 0px none rgb(0, 0, 0); width: 13px; height: 20px;">
										<p style="text-align: center; line-height: 1.6; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">:</p>
									</td>
									<td scope="" style="border: 0px none rgb(0, 0, 0); width: 788px; height: 20px;" colspan="3">
										<p style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; line-height: 1.8; margin-top: 0px; margin-bottom: 0px;">
											<span id="1451_jyqm70vn96e2" style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px;">${requestScope.empProofDetail.empName}</span>
											<span style="text-align: inherit; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px;">&nbsp;</span>
										</p>
									</td>
								</tr>
								<tr>
									<td scope="" style="border: 0px none rgb(0, 0, 0); width: 66px; height: 20px;">
										<p style="text-align: justify; line-height: 1.6; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">생년월일</p>
									</td>
									<td scope="" style="border: 0px none rgb(0, 0, 0); width: 13px; height: 20px;">
										<p style="text-align: center; line-height: 1.6; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">:</p>
									</td>
									<td colspan="3" scope="" style="border: 0px none rgb(0, 0, 0); width: 788px; height: 20px;">
										<p style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; line-height: 1.8; margin-top: 0px; margin-bottom: 0px;">
											<span id="1451_jyqm7pkowplp" style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px;">${requestScope.empProofDetail.birth}</span>
										</p>
									</td>
								</tr>
								<tr>
									<td scope="" style="border: 0px none rgb(0, 0, 0); width: 66px; height: 20px;">
										<p style="text-align: justify; line-height: 1.6; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
											소&nbsp;&nbsp;&nbsp;&nbsp; 속<br>
										</p>
									</td>
									<td scope="" style="border: 0px none rgb(0, 0, 0); width: 13px; height: 20px;">
									...
									<td colspan="3" scope="" style="border: 0px none rgb(0, 0, 0); width: 788px; height: 20px;">
										<p style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; line-height: 1.8; margin-top: 0px; margin-bottom: 0px;">
											<span id="1451_jyqm7pko76zn" style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px;">${requestScope.empProofDetail.team}</span>
										</p>
									</td>
								</tr>
								<tr>
									<td scope="" style="border: 0px none rgb(0, 0, 0); width: 66px; height: 20px;">
										<p style="text-align: justify; line-height: 1.6; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">입 사 일</p>
									</td>
									<td scope="" style="border: 0px none rgb(0, 0, 0); width: 13px; height: 20px;">
										<p style="text-align: center; line-height: 1.6; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">:</p>
									</td>
									<td colspan="3" scope="" style="border: 0px none rgb(0, 0, 0); width: 788px; height: 20px;">
										<p style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; line-height: 1.8; margin-top: 0px; margin-bottom: 0px;">
											<span id="1451_jyqm7pkorbih" style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px;">${requestScope.empProofDetail.startWorkDay}</span>
										</p>
									</td>
								</tr>
								<tr>
									<td colspan="5" scope="" style="border: 0px none rgb(0, 0, 0); width: 867px; height: 20px;">
										<p style="text-align: center; line-height: 1.4; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
											<span class="hw-editable-false" style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px;">&nbsp;</span>
										</p>
										<p style="text-align: center; line-height: 1.4; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
											<span class="hw-editable-false" style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px;">&nbsp;</span>
										</p>
										...
										<p style="text-align: center; line-height: 1.4; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
											<span class="hw-editable-false" id="4_jyi2cncddbr0" style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px;">이 사람은&nbsp;</span>
											<span style="text-align: inherit; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px;">상기 입사일 이후 현재까지 당사에 재직 중임을 확인합니다.</span>
										</p>
										<p style="text-align: center; line-height: 1.4; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
											<span style="text-align: inherit; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px;">&nbsp;</span>
										</p>
								...
								<tr>
									<td scope="" style="border: 0px none rgb(0, 0, 0); width: 66px; height: 20px;">
										<p style="line-height: 1.8; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">제 출 처</p>
									</td>
									<td scope="" style="border: 0px none rgb(0, 0, 0); width: 13px; height: 20px;">
										<p style="line-height: 1.8; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">&nbsp;:</p>
									</td>
									<td colspan="3" scope="" style="border: 0px none rgb(0, 0, 0); width: 788px; height: 20px;">
										<p style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; line-height: 1.8; margin-top: 0px; margin-bottom: 0px;">
											<span id="1451_jyqm7ruune38" style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px;">${requestScope.empProofDetail.submit}</span>
											<span style="text-align: inherit; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px;">&nbsp;</span>
										</p>
									</td>
								</tr>
								<tr>
									<td scope="" style="border: 0px none rgb(0, 0, 0); width: 66px; height: 20px;">
										<p style="line-height: 1.8; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">용&nbsp; &nbsp; &nbsp;도</p>
									</td>
									<td scope="" style="border: 0px none rgb(0, 0, 0); width: 13px; height: 20px;">
										<p style="line-height: 1.8; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">&nbsp;:</p>
									</td>
									<td colspan="3" scope="" style="border: 0px none rgb(0, 0, 0); width: 788px; height: 20px;">
										<p style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; line-height: 1.8; margin-top: 0px; margin-bottom: 0px;">
											<span id="1451_jyqm7s52nazl" style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px;">${requestScope.approvalDetail.content}</span>
										</p>
									</td>
								</tr>
								<tr>
									<td colspan="5" scope="" style="border: 0px none rgb(0, 0, 0); width: 600px; height: 20px;">
										<p style="line-height: 1.6; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
											<span class="hw-editable-false" style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 14px;">&nbsp;</span>
										</p>
										<p style="line-height: 1.6; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
											<span class="hw-editable-false" style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 14px;">&nbsp;</span>
										</p>
										...
										<p style="text-align: center; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; line-height: 1.8; margin-top: 0px; margin-bottom: 0px;">
											<span id="1451_jzxgpuw5qgjv" style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px;">${requestScope.empProofDetail.issueDay}</span>
										</p>
										<p style="text-align: center; line-height: 1.8; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
											<span style="text-align: inherit; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 14px;">&nbsp;</span>
										</p>
										<p style="text-align: center; line-height: 1.8; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
											<span style="text-align: inherit; font-size: 14px;">
												<br>
											</span>
										</p>
										<p style="text-align: center; line-height: 1.8; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
										...
										<p style="line-height: 1.6; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
											<span class="hw-editable-false" style="font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 14px;">&nbsp;</span>
											<span style="font-size: 14px; text-align: inherit; font-family: &amp; quot;맑은 고딕&amp;quot;;">&nbsp;</span>
										</p>
									</td>
								</tr>
								<tr>
									<td colspan="5" scope="" style="border: 0px none rgb(0, 0, 0); width: 866px; height: 70px; background-repeat: no-repeat;">
										<p style="text-align: center; line-height: 1.6; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
											<img src="<%= ctxPath %>/resources/image/dbunit_sign_for_com.png" border="0" style="border: 0px solid rgb(0, 0, 0); width: 531px; height: 70px; margin: 0px;">
											<br>
										</p>
									</td>
								</tr>
						...
						<p style="margin: 0cm 0cm 8pt; text-align: justify; line-height: 14.26px; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 10pt;">
							<span style="line-height: 15.69px; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 11pt;">&nbsp; &nbsp; </span>
							<span style="text-align: center; font-family: &amp; quot; 맑은 고딕&amp;quot;; font-size: 12pt;">&nbsp;</span>
						</p>
					</div>
