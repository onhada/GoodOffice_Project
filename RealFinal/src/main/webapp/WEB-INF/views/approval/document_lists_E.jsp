...
$(document).ready(function() {
	...
	$("tr.tableData").each(function(){
		$(this).click(function(){
			...
			$(location).attr('href', '<%=ctxPath%>/approval/documentDetail/list/E/view.gw?formId=' + formId + '&approvalId=' + $(this).find("td.docu-num div").html());
		})
	})
	...
	$("button#anchorApprovalForm").click(function(){
		$("ul#menuApprovalFormMode").toggle();
	})
})
</script>
