...
S					}else{
	...
	$(document).on("mousedown", "ul.approval_autocomplete li", function() {
		...
		if(isExist){
			...
			html += `<li class="js-approval-line-setting unsortable" id="approvalLineSettingEmpId_` + empId +`" style="cursor: auto;"><span>` + empName + `<span class="icon file_delete js-approval-line-setting-delete" onclick ="deleteThis(approvalLineSettingEmpId_` + empId + `)"></span></span><span style="display:none;">` + positionName + `</span></li>`;
