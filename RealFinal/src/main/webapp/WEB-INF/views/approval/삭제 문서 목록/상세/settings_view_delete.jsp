...
<div id="contents">
		...
		<form>
			<fieldset>
				<span class="detail_select"> <a href="javascript:void(0);"
					onclick="ApprovalSetting.batchManage('RESTORE', '', 'view');">복원</a>
				</span> <span class="detail_select"> <a href="javascript:void(0);"
					onclick="ApprovalSetting.batchManage('DELETE_FOREVER', '', 'view');">완전삭제</a>
				</span>
			</fieldset>
		</form>
	</div>
	<input type="checkbox" class="hide js-checkbox-document-list"
		value="7584" checked="checked"> <input type="hidden"
		name="approval_document_no" value="7584">
		...
		<div class="cont_box view">
			<div class="approval-wrap write view">
				...
				<table class="cal_table1  approve-write refer js-approval-line">
					...
					<tbody>
						<tr>
							<th scope="row">
								<div class="choice"
									style="min-height: 45px; height: 44px; display: table-cell; width: 108px; vertical-align: middle; text-align: center;">
									참조</div>
							</th>
				...
				<div class="docu-common-wrap">
					<h2>
						<span class="point_color"> </span> ㅇㅇ
					</h2>
				...
				<ul id="approvalCommentsHistory">
					...
					<li>
						...
						<div class="txt">
							<div class="hidden after">
								...
								<p class="date">2023-12-03 10:03:25</p>
					...
					<li>
						...
						<div class="txt">
							<div class="hidden after">
								<p class="name bold">대표이사</p>
								<p class="date">2023-12-03 10:34:42</p>

							</div>
							<p>
								<span style="color: #acacac;">관리자에 의한 삭제</span>
							</p>
						</div>
					</li>
				</ul>
	...
	<script>
		ApprovalSetting._documentNo = '7584';
