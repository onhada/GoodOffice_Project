...
$(document).ready(function() {
	...
	$("td.tableData").each(function(){
		$(this).click(function(){
			...
			$(location).attr('href', '<%=ctxPath%>/approval/documentDetail/box/read/view.gw?formId=' + formId + '&approvalId=' + $(this).parent().find("td.docu-num div").html());
		})
	})
		...
		<div class="content_title js-approval-box-type">
			<span class="detail_select mgl_5">
				...
				<ul class="dropdown-menu block hide" style="max-height: 550px; overflow-y: auto; /* padding-right: 8px; */ top: 20px; left: 0;" id="menuApprovalTypeMode">
					<li>
						<a href="<%=ctxPath%>/approval/document/box/read.gw" class="js-approval-li-types">모든 문서</a>
					</li>
					<li>
