...
<div id="contents">
	...
	<!-- <input type="hidden" name="approval_document_no" value="30927">
	<input type="hidden" name="approval_first_line" value="3848">
	<input type="hidden" name="approval_second_line" value="3878">
				...
				<div class="docu-common-wrap">
					...
					<div class="contents after">
						<div class="hw-approval-docs">
							...
							<section>
								<h4 class="section-title">근무일</h4>
								<div class="section-data">${requestScope.modifyWorkRequest.workDay}</div>
							</section>
							<section>
								<h4 class="section-title">적용대상</h4>
								<div class="section-data">${requestScope.modifyWorkRequest.empName}</div>
							</section>
							<section>
								<h4 class="section-title">근무체크 수정 요청</h4>
								<div class="section-data">
									<table class="setting-table center">
										<colgroup>
											<col>
											<col>
											<col>
							...
							<section>
								<h4 class="section-title">상세</h4>
								<div class="section-data">${requestScope.approvalDetail.content}</div>
							</section>
						</div>
					</div>
