...
<div id="contents">
	<form autocomplete="off" onsubmit="return false;">
				...
				<div class="approval-wrap write">
					<h4 style="display: inline-block">
						기본 설정 <a href="javascript:void(0);" class="mgl_20 weakblue hide"
							...
							style="display: inline;">사내전자결재규정</a>
					</h4>
					<span class="gt-float-right gt-mt-5"> <a
						href="/tempfinal.onhiworks.com/approval/document/write_test"
							...
							<tr>
								...
								<td><select name="approval_category_no"
									class="write-select" autocomplete="off">
										<option value="685" selected="">공통</option>
								</select> <input type="hidden" id="prevApprovalCategoryNo" value="685">
									...
									autocomplete="off">
										...
										<option value="5519">지출 결의서</option>
										<option value="5520">회람</option>
										<option value="5521">업무연락</option>
										<option value="5522">품의서</option>
								</select>
									<button class="weakblue"
										onclick="ApprovalDocument.getSelectApprovalForm();">문서보기</button>
									<input type="hidden" id="prevApprovalFormNo" value="5522">
									<input type="hidden" id="prevApprovalFormTitle" value="">
								</td>
								<th scope="row">작성자</th>
								<td><input type="hidden" name="node_id" value="2816">
									하이웍스오피스 <span>관리자</span></td>
							</tr>
							<tr>
									...
									<div class="tooltip hide" style="right: 150px; top: 0;">
										<div class="tooltip-box" style="width: 450px;">
											<p>ㆍS등급: 기안 상에 설정된 관련자들만 문서를 볼 수 있으며, 결재자와 합의자만 참조자를 추가할
												수 있음.</p>
											<p>ㆍA등급: 기안 상에 설정된 관련자들과 관리자가 설정한 5등급(과장)등급 이상인 사람이 문서를 볼
												수 있음. 결재자와 합의자는 참조자를 추가할 수 있음.</p>
											<p>ㆍB등급: 기안 상에 설정된 관련자들과 관리자가 설정한 7등급(사원)등급 이상인 사람이 문서를 볼
					...
					<div class="after">
						...
						<a id="universalGuide" href="https://www.hiworks.com/guide_mov"
							target="_blank"><button type="button" class="fr weakblue vt"
								id="btnUniversalGuide">결재-합의 통합 설정 가이드</button></a>
					</div>
					<div id="approvalDocumentLine">
											...
											<tbody>
												...
												<tr>
													<td class="name gt-position-relative"><span
														class="stamp-step-num">1</span>관리자</td>
									...
									<td class="agree vt" id="approvalSecondLine">
										<table>
											...
											<tbody>
												<tr>
													<td
														class="gt-ph-20 gt-align-left gt-border-0 gt-position-relative">
													</td>
													<td
														class="gt-ph-20 gt-align-left gt-border-0 gt-position-relative">
													</td>
						...
						<table class="cal_table1  approve-write refer js-approval-line">
							...
							<tbody>
								<tr>
									<th scope="row">참조</th>
									<td id="approvalFourthLine" style="height: 28px;"><input
										type="text"
					...
					<div class="write_input hide" id="approvalEditorContent"
						...
						<div class="txt file">
							...
							<div id="new_compose_contents"
								...
								style="width: 100%; height: 500px; visibility: visible;">
                        ...
                        <g>
                            ...
                            <rect x="11" y="1" fill="#C9C9C9" width="1"
												...
												<button type="button"
													class="se-button se-clickable se-hidden"
												...
												<button type="button"
													class="se-button se-clickable se-disable se-hidden"
					...
					<div class="js-approval-input hide" id="approvalDbContent"
						style="display: block;">
						<div class="after mgt_15">
							<h4 class="fl">송금요청</h4>
							<button type="button" class="weakblue mgl_20 vt"
								onclick="ApprovalDocument.getRemittanceRequestLayer();">추가</button>
						</div>
						<table class="tableType01 account mgb_20 hide"
							id="tableRemittanceRequest">
							<colgroup>
								<col>
								<col>
								<col>
						...
						<p class="font12 pdb_20" style="display: none;"
							id="irregular_display">
							<span class="red_color">*</span> 비정기 거래처
						</p>
		...
		<input type="hidden" name="approval_document_no" value=""> <input
			type="hidden" name="approval_first_line" value="3847|2816"> <input
