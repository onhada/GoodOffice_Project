			...
			<div data-v-aaa54904="" class="summary-wrap" style="display: none;">
				<div data-v-aaa54904="" class="summary-inner">
					<div data-v-aaa54904="" class="inner-wrap">
						<a data-v-aaa54904="" href="https://mail.office.hiworks.com/gabia.biz/mail/webmail" target="_self" class="menu">
							<span data-v-aaa54904="" class="inner">
								
								<span data-v-aaa54904="" class="icon">
					...
					<div data-v-aaa54904="" class="inner-wrap">
						<a data-v-aaa54904="" href="https://board.office.hiworks.com/gabia.biz/bbs/board/board_list" target="_self" class="menu">
							<span data-v-aaa54904="" class="inner">
								
								<span data-v-aaa54904="" class="icon">
									<svg class="service-menu-icon" xmlns="http://www.w3.org/2000/svg" width="28" 897"="" height="28" viewBox="0 0 14.897 18">
										<g transform="translate(-253.062 -271)">
										<g transform="translate(253.062 271)">
										<g transform="translate(0 2.483)">
										<path class="svg-hover-color" d="M118.655,667.241v13.035H106.241V667.241h12.414m0-1.241H106.241A1.241,1.241,0,0,0,105,667.241v13.035a1.241,1.241,0,0,0,1.241,1.241h12.414a1.241,1.241,0,0,0,1.241-1.241V667.241A1.241,1.241,0,0,0,118.655,666Z" transform="translate(-105 -666)" fill="#5b6164"></path>
										<rect width="8.69" height="1.241" rx="0.621" transform="translate(3.103 3.103)" fill="#4e9bd4"></rect>
										<rect width="4.966" height="1.241" rx="0.621" transform="translate(3.103 6.207)" fill="#4e9bd4"></rect></g>
										<g transform="translate(3.38)">
										<path class="svg-hover-color" d="M117.893,665.62l-3.38-2.253-3.38,2.253-.689-1.033,3.724-2.483a.621.621,0,0,1,.689,0l3.724,2.483Z" transform="translate(-110.445 -662)" fill="#5b6164"></path></g></g></g></svg>
								</span>
							</span>
						</a>
					</div>
					<div data-v-aaa54904="" class="inner-wrap">
						<a data-v-aaa54904="" href="https://sms.office.hiworks.com/gabia.biz/sms/sms_main" target="_self" class="menu">
							<span data-v-aaa54904="" class="inner">
								...
								<span data-v-aaa54904="" class="icon">
									<svg class="service-menu-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 18 18">
										...
										<path class="svg-hover-color" fill="#5b6164" d="M203.4 128.473h-7.309a9 9 0 0 1-.04-18h.05a9 9 0 0 1 8.983 9v7.311a1.694 1.694 0 0 1-1.684 1.689zm-7.308-1.284h7.308a.405.405 0 0 0 .4-.4v-7.311a7.718 7.718 0 0 0-7.7-7.714 7.714 7.714 0 0 0 0 15.428z"></path>
										<circle class="svg-hover-color" cx="1" cy="1" r="1" fill="#4e9bd4" transform="translate(197.787 118.746)"></circle>
										<circle class="svg-hover-color" cx="1" cy="1" r="1" fill="#4e9bd4" transform="translate(194.787 118.746)"></circle>
										<circle class="svg-hover-color" cx="1" cy="1" r="1" fill="#4e9bd4" transform="translate(191.787 118.746)"></circle></g></svg>
								</span>
							</span>
						</a>
					</div>
					<div data-v-aaa54904="" class="inner-wrap">
						<a data-v-aaa54904="" href="https://bill.office.hiworks.com/gabia.biz/bill/manage/main" target="_self" class="menu">
							<span data-v-aaa54904="" class="inner">
					...
					<div data-v-aaa54904="" class="inner-wrap">
						<a data-v-aaa54904="" href="https://calendar.office.hiworks.com/gabia.biz/schedule/schedulemain" target="_self" class="menu">
							<span data-v-aaa54904="" class="inner">
								
								<span data-v-aaa54904="" class="icon">
									<svg class="service-menu-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 18 17">
										<g transform="translate(-467.343 -271)">
										<path class="svg-hover-color" d="M359.714,665.308H356.5V664h-1.286v1.308h-6.429V664H347.5v1.308h-3.214A1.3,1.3,0,0,0,343,666.615v13.077A1.3,1.3,0,0,0,344.286,681h15.429A1.3,1.3,0,0,0,361,679.692V666.615A1.3,1.3,0,0,0,359.714,665.308Zm0,14.385H344.286V666.615h15.429Z" transform="translate(124.343 -393)" fill="#5b6164"></path>
										<g transform="translate(471.843 278.192)">
										<path class="svg-hover-color" d="M351.414,677.71h.662a.92.92,0,0,0,.7-.241.889.889,0,0,0,.228-.638.783.783,0,0,0-.226-.6.865.865,0,0,0-.62-.214.911.911,0,0,0-.6.2.641.641,0,0,0-.24.518h-1.242a1.566,1.566,0,0,1,.265-.893,1.759,1.759,0,0,1,.739-.618,2.424,2.424,0,0,1,1.047-.223,2.315,2.315,0,0,1,1.556.483,1.664,1.664,0,0,1,.563,1.332,1.355,1.355,0,0,1-.262.8,1.709,1.709,0,0,1-.688.563,1.558,1.558,0,0,1,.788.577,1.58,1.58,0,0,1,.26.909,1.687,1.687,0,0,1-.608,1.359,2.418,2.418,0,0,1-1.609.511,2.292,2.292,0,0,1-1.532-.5,1.652,1.652,0,0,1-.6-1.329h1.242a.737.737,0,0,0,.264.586,1.086,1.086,0,0,0,1.345-.011.829.829,0,0,0,.251-.632q0-.953-1.031-.953h-.658Z" transform="translate(-350 -675)" fill="#4e9bd4"></path>
										<path class="svg-hover-color" d="M361.471,681.539H360.2v-5l-1.521.48v-1.054l2.659-.968h.136Z" transform="translate(-353.099 -675)" fill="#4e9bd4"></path></g>
										<rect width="15.429" class="svg-hover-color" height="1.308" transform="translate(468.628 275.577)" fill="#5b6164"></rect></g></svg>
								</span>
							</span>
						</a>
					</div>
					<div data-v-aaa54904="" class="inner-wrap">
						<a data-v-aaa54904="" href="https://teammail.office.hiworks.com/gabia.biz/shared/main/sList" target="_self" class="menu">
							<span data-v-aaa54904="" class="inner">
								
								<span data-v-aaa54904="" class="icon">
									<svg class="service-menu-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 18 14">
										<g>
										<path class="svg-hover-color" fill="#4e9bd4" d="M397.838 582.64a1.3 1.3 0 0 1-.725-.221l-4.016-3.028a.626.626 0 1 1 .753-1l3.986 3.006s.029 0 .054-.021l3.955-2.986a.626.626 0 0 1 .753 1l-3.985 3.007a1.384 1.384 0 0 1-.775.243z" transform="translate(-754.684 -780) translate(367.037 204.734)"></path>
										<path class="svg-hover-color" fill="#5b6164" d="M397.346 155.822H383.2a.64.64 0 0 0-.643.637v1.909h-1.928a.639.639 0 0 0-.642.636v10.183a.638.638 0 0 0 .642.635h14.146a.638.638 0 0 0 .639-.638v-1.907h1.93a.64.64 0 0 0 .642-.637v-10.181a.64.64 0 0 0-.64-.637zm-3.213 12.725h-12.858v-8.909h1.285v7a.64.64 0 0 0 .643.637h10.93zm2.57-2.542h-12.857V157.1H396.7z" transform="translate(-754.684 -780) translate(374.695 624.178)"></path></g></svg>
								</span>
							</span>
						</a>
					</div>
					<div data-v-aaa54904="" class="inner-wrap">
						<a data-v-aaa54904="" href="https://contacts.office.hiworks.com/gabia.biz/addr/main" target="_self" class="menu">
							<span data-v-aaa54904="" class="inner">
								
								<span data-v-aaa54904="" class="icon">
									<svg xmlns="http://www.w3.org/2000/svg" class="service-menu-icon" width="28" height="28" viewBox="0 0 17 18">
										<g id="service-menu-icon03_s" transform="translate(-360 -271)">
										<path class="svg-hover-color" d="M0,0H2V2.955H0Z" transform="translate(360 275)" fill="#5b6164"></path>
										<path class="svg-hover-color" d="M0,0H2V2.955H0Z" transform="translate(360 281.895)" fill="#5b6164"></path>
										<path class="svg-hover-color" d="M250.942,110.908v15.4h-13.4v-15.4h13.4m.8-1.3h-15a.5.5,0,0,0-.5.5v17a.5.5,0,0,0,.5.5h15a.5.5,0,0,0,.5-.5v-17a.5.5,0,0,0-.5-.5Z" transform="translate(124.758 161.392)" fill="#5b6164"></path>
										<g transform="translate(132 -396)">
										<path class="svg-hover-color" d="M240,677.33v.544a.635.635,0,0,1-.643.627h-4.715a.635.635,0,0,1-.643-.627v-.544a1.778,1.778,0,0,1,1.8-1.755h.223a2.39,2.39,0,0,0,1.953,0h.223A1.778,1.778,0,0,1,240,677.33Zm-4.667-3.7A1.667,1.667,0,1,1,237,675.25,1.646,1.646,0,0,1,235.333,673.625Z" fill="#4e9bd4"></path></g></g></svg>
								</span>
							</span>
						</a>
					</div>
					<div data-v-aaa54904="" class="inner-wrap">
						<a data-v-aaa54904="" href="https://booking.office.hiworks.com/gabia.biz/booking/bookingMain" target="_self" class="menu">
							<span data-v-aaa54904="" class="inner">
					...
					<div data-v-aaa54904="" class="inner-wrap">
						<a data-v-aaa54904="" href="https://office.hiworks.com/gabia.biz/insa/info/member" target="_self" class="menu">
							<span data-v-aaa54904="" class="inner">
					...
					<div data-v-aaa54904="" class="inner-wrap">
						<a data-v-aaa54904="" href="https://approval.office.hiworks.com/gabia.biz/approval/document" target="_self" class="menu">
							<span data-v-aaa54904="" class="inner">
					...
					<div data-v-aaa54904="" class="inner-wrap">
						<a data-v-aaa54904="" href="https://plus.office.hiworks.com/" target="_self" class="menu">
							<span data-v-aaa54904="" class="inner">
								
								<span data-v-aaa54904="" class="icon">
									<svg class="service-menu-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 18 18">
										<g>
										<path fill="none" d="M0 0H17.782V17.731H0z" transform="translate(-864 -778.727) translate(864 778.996)"></path>
										<path class="svg-hover-color" fill="#4e9bd4" d="M568.2 576.4a.642.642 0 0 1-.643-.641 3.214 3.214 0 0 0-6.428 0 .643.643 0 0 1-1.286 0 4.5 4.5 0 0 1 9 0 .642.642 0 0 1-.643.641z" transform="translate(-864 -778.727) translate(308.653 207.458)"></path>
										<path class="svg-hover-color" fill="#5b6164" d="M570.2 591.269h-16.709a.639.639 0 0 1-.643-.636v-12.728a.64.64 0 0 1 .643-.636H570.2a.64.64 0 0 1 .643.636v12.727a.639.639 0 0 1-.643.637zM554.134 590h15.427v-11.458h-15.427z" transform="translate(-864 -778.727) translate(311.153 205.304)"></path></g></svg>
								</span>
							</span>
						</a>
					</div>
					<div data-v-aaa54904="" class="inner-wrap">
						<a data-v-aaa54904="" href="https://groups.office.hiworks.com/group/main" target="_self" class="menu">
							<span data-v-aaa54904="" class="inner">
								
								<span data-v-aaa54904="" class="icon">
									<svg class="service-menu-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 18 15">
										<g transform="translate(-149.342 -24.601)">
										<g>
										<path class="svg-hover-color" d="M153.787 28.578a1.41 1.41 0 1 1 .827-2.588 4.593 4.593 0 0 1 .779-.857 2.565 2.565 0 1 0-1.548 4.605c.028 0 .054-.008.082-.008a4.521 4.521 0 0 1-.141-1.122c-.001-.008.001-.02.001-.03z" fill="#5b6164"></path>
										<path class="svg-hover-color" d="M150.5 33.718v-.642a1.543 1.543 0 0 1 1.543-1.54 1.134 1.134 0 0 1 .32.077 4.466 4.466 0 0 0 1.481.243 4.289 4.289 0 0 0 1.165-.152 4.6 4.6 0 0 1-.728-1.032 3.392 3.392 0 0 1-.438.029c-.947 0-1.222-.32-1.8-.32a2.7 2.7 0 0 0-2.7 2.695v.834a.964.964 0 0 0 .964.963h1.135a4.641 4.641 0 0 1 .819-1.155z" fill="#5b6164"></path>
										<path class="svg-hover-color" d="M162.108 25.977a1.407 1.407 0 1 1 .84 2.6v.036a4.6 4.6 0 0 1-.142 1.126h.038a2.567 2.567 0 1 0-1.527-4.626 4.6 4.6 0 0 1 .791.864z" fill="#4e9bd4"></path>
										<path class="svg-hover-color" d="M164.646 30.381c-.576 0-.854.32-1.8.32a3.58 3.58 0 0 1-.4-.023 4.533 4.533 0 0 1-.733 1.036 4.266 4.266 0 0 0 1.13.143 4.476 4.476 0 0 0 1.482-.243 1.129 1.129 0 0 1 .318-.077 1.542 1.542 0 0 1 1.543 1.54v.642H164.3a4.645 4.645 0 0 1 .82 1.155h1.257a.964.964 0 0 0 .965-.962v-.835a2.7 2.7 0 0 0-2.696-2.696z" fill="#4e9bd4"></path>
										<g>
										<path class="svg-hover-color" d="M158.377 26.088a2.511 2.511 0 1 1-2.517 2.512 2.516 2.516 0 0 1 2.517-2.511m0-1.156a3.667 3.667 0 1 0 3.673 3.667 3.668 3.668 0 0 0-3.672-3.667z" fill="#5b6164"></path>
										<path class="svg-hover-color" d="M160.949 34.338a2.7 2.7 0 0 1 2.7 2.695v1.192a.22.22 0 0 1-.22.219h-10.106a.22.22 0 0 1-.22-.219v-1.192a2.7 2.7 0 0 1 2.7-2.695 1.964 1.964 0 0 1 .606.133 6.1 6.1 0 0 0 3.933 0 1.962 1.962 0 0 1 .6-.132m0-1.155c-.823 0-1.22.458-2.571.458s-1.746-.458-2.572-.458a3.855 3.855 0 0 0-3.858 3.85v1.192a1.377 1.377 0 0 0 1.379 1.375h10.1a1.377 1.377 0 0 0 1.378-1.375v-1.192a3.855 3.855 0 0 0-3.858-3.85z" fill="#5b6164"></path></g></g></g></svg>
								</span>
							</span>
						</a>
					</div>
					<div data-v-aaa54904="" class="inner-wrap">
						<a data-v-aaa54904="" href="https://office.hiworks.com/gabia.biz/h_admin/adminhome" target="_self" class="menu">
							<span data-v-aaa54904="" class="inner">
					...
					<div data-v-aaa54904="" class="inner-wrap">
						<a data-v-aaa54904="" href="https://office.hiworks.com/gabia.biz/accounting/basic/criteria" target="_self" class="menu">
							<span data-v-aaa54904="" class="inner">
					...
					<div data-v-aaa54904="" class="inner-wrap">
						<a data-v-aaa54904="" class="top-button">
							<span data-v-aaa54904="" class="inner">
								<i data-v-aaa54904="" class="fal fa-chevron-double-up"></i>
							</span>
						</a>
					</div>
				</div>
