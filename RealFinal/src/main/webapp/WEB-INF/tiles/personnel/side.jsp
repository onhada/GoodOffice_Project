...
<div class="split-item left" style="width: 276px;">
	<div data-v-3c987196="" class="sidebar" style="f616: #f7faff; --3 fa7187a: rgba(41, 133, 219, 0.1); - -be93eab8: #056ac9;">
		<div data-v-3c987196="" class="fixed-area top">
			<a data-v-3c987196="" href="https://hr-work.office.hiworks.com/approval/vacation-apply" class="main-button mb-20">
					...
					<div data-v-3c987196="" role="tablist" aria-multiselectable="true" class="el-collapse mt-8">
						<div data-v-318760de="" data-v-3c987196="" class="el-collapse-item is-active">
							<div role="tab" aria-expanded="true" aria-controls="el-collapse-content-6849" aria-describedby="el-collapse-content-6849">
								<div role="button" id="el-collapse-head-6849" tabindex="0" class="el-collapse-item__header is-active">
							...
							<div role="tabpanel" aria-labelledby="el-collapse-head-6849" id="el-collapse-content-6849" class="el-collapse-item__wrap">
								<div class="el-collapse-item__content">
									<a data-v-318760de="" href="https://hr-work.office.hiworks.com/personal/index" class="menu-item sub">
      ...
      <path data-name="제외 6" d="M11367.189 23493h-9.375a2.816 2.816 0 0 1-2.812-2.812 8.333 8.333 0 0 1 2-5.508 13.765 13.765 0 0 1 3.245-2.682c.13-.086.246-.16.358-.23l.024-.016h3.75a3.656 3.656 0 0 1 .354.246 13.518 13.518 0 0 1 3.269 2.682 8.311 8.311 0 0 1 2 5.508 2.816 2.816 0 0 1-2.813 2.812zm-4.687-5.389 1.037 2.51a.493.493 0 0 0 .459.313h.03a.507.507 0 0 0 .454-.371l.4-1.451a.859.859 0 0 0 .118.012h.5a.5.5 0 1 0 0-1h-.348l.33-1.191a.5.5 0 0 0-.354-.611.466.466 0 0 0-.13-.02.5.5 0 0 0-.483.367l-.613 2.229-.943-2.289a.5.5 0 0 0-.926 0l-.943 2.289-.613-2.229a.491.491 0 0 0-.474-.367.507.507 0 0 0-.14.02.491.491 0 0 0-.348.611l.33 1.191h-.348a.5.5 0 1 0 0 1h.5a.6.6 0 0 0 .1-.01h.015l.395 1.451a.521.521 0 0 0 .454.371h.029a.511.511 0 0 0 .466-.312l1.037-2.51zm1.875-6.8h-3.75l-1.392-2.088a.454.454 0 0 1-.022-.475.459.459 0 0 1 .412-.25h5.748a.462.462 0 0 1 .418.252.449.449 0 0 1-.028.473l-1.386 2.086z" transform="translate(-11354.502 -23477.5)" style="fill:#909090;"></path>
					...
					<div data-v-3c987196="" role="tablist" aria-multiselectable="true" class="el-collapse">
						<div data-v-318760de="" data-v-3c987196="" class="el-collapse-item mt-8 is-active">
							<div role="tab" aria-expanded="true" aria-controls="el-collapse-content-5519" aria-describedby="el-collapse-content-5519">
								<div role="button" id="el-collapse-head-5519" tabindex="0" class="el-collapse-item__header is-active">
									<span data-v-318760de="" class="collapse-title-wrapper menu-item">
										<i data-v-318760de="" class="fal fa-chevron-down collapse-prefix-icon"></i>
										<span data-v-318760de="" class="collapse-title">근무관리</span>
									</span>
									<i class="el-collapse-item__arrow el-icon-arrow-right is-active"></i>
								</div>
							</div>
							<div role="tabpanel" aria-labelledby="el-collapse-head-5519" id="el-collapse-content-5519" class="el-collapse-item__wrap">
								<div class="el-collapse-item__content">
									<a data-v-318760de="" href="https://hr-work.office.hiworks.com/department/monthly-manage" class="menu-item sub">
										<i data-v-318760de="" class="gis gi-calendar-6dot link-prefix-icon"></i>
										<span data-v-318760de="">근무계획 수립</span>
									</a>
									<a data-v-318760de="" href="https://hr-work.office.hiworks.com/department/statistics" class="menu-item sub">
										<i data-v-318760de="" class="gis gi-chart-pie link-prefix-icon"></i>
										<span data-v-318760de="">근무통계</span>
									</a>
									<a data-v-318760de="" href="https://hr-work.office.hiworks.com/department/work-manage" class="menu-item sub">
										<i data-v-318760de="" class="gis gi-company link-prefix-icon"></i>
										<span data-v-318760de="">전사 근무관리</span>
									</a>
								</div>
							</div>
						</div>
						...
						<div data-v-318760de="" data-v-3c987196="" class="el-collapse-item mt-8 is-active">
							<div role="tab" aria-expanded="true" aria-controls="el-collapse-content-1636" aria-describedby="el-collapse-content-1636">
								<div role="button" id="el-collapse-head-1636" tabindex="0" class="el-collapse-item__header is-active">
									<span data-v-318760de="" class="collapse-title-wrapper menu-item">
										<i data-v-318760de="" class="fal fa-chevron-down collapse-prefix-icon"></i>
							...
							<div role="tabpanel" aria-labelledby="el-collapse-head-1636" id="el-collapse-content-1636" class="el-collapse-item__wrap">
								<div class="el-collapse-item__content">
									<!-- <a data-v-318760de="" href="https://hr-work.office.hiworks.com/settings" class="menu-item sub">
										<span data-v-3492dd16="" data-v-318760de="" class="link-prefix-icon useIconColor" style="e9135: #909090;">
											<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
      <g data-name="Layer 1">
          <path data-name="패스 4108"
													d="m14.82 9.092-.474-.28-.434-.25v-1.12l.434-.25.5-.29a1.286 1.286 0 0 0 .622-1.39 5.372 5.372 0 0 0-.562-1.43 6.273 6.273 0 0 0-.987-1.32 1.244 1.244 0 0 0-.878-.36 1.289 1.289 0 0 0-.651.18l-.483.28-.523.25a5.9 5.9 0 0 0-.987-.56v-1.09a1.281 1.281 0 0 0-.786-1.24 5.193 5.193 0 0 0-1.51-.22 6.118 6.118 0 0 0-1.647.23 1.288 1.288 0 0 0-.927 1.25v1.07a5.9 5.9 0 0 0-.992.56l-.434-.25-.5-.29a1.318 1.318 0 0 0-.661-.18 1.2 1.2 0 0 0-.829.33 5.325 5.325 0 0 0-.886 1.2 6.319 6.319 0 0 0-.621 1.55 1.3 1.3 0 0 0 .6 1.44l.483.28.385.23v1.12l-.437.25-.5.29a1.287 1.287 0 0 0-.6 1.41 5.372 5.372 0 0 0 .562 1.43 6.263 6.263 0 0 0 .987 1.32 1.244 1.244 0 0 0 .878.36 1.289 1.289 0 0 0 .651-.18l.483-.28.385-.23a5.9 5.9 0 0 0 .987.56v1.09a1.276 1.276 0 0 0 .987 1.22 5.193 5.193 0 0 0 1.47.22 6.118 6.118 0 0 0 1.638-.23 1.288 1.288 0 0 0 .927-1.25v-1.07a5.9 5.9 0 0 0 .987-.56l.385.23.5.29a1.318 1.318 0 0 0 .661.18 1.2 1.2 0 0 0 .829-.33 5.315 5.315 0 0 0 .987-1.21 6.329 6.329 0 0 0 .622-1.55 1.3 1.3 0 0 0-.641-1.41zm-6.807.91a2 2 0 1 1 1.973-2 1.987 1.987 0 0 1-1.973 2z"
												></path>
      </g>
  </svg>
										</span>
										<span data-v-318760de="">기본설정</span>
									</a> -->
									<!-- 
									<a data-v-318760de=""
										href="https://hr-work.office.hiworks.com/attendance/work-setting"
										class="menu-item sub"><i data-v-318760de=""
										class="gis gi-user-clock link-prefix-icon"></i><span
										data-v-318760de="">근로형태</span></a>
									 -->
