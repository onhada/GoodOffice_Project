...
public class FileManager {
	...
	public String doFileUpload(byte[] bytes, String originalFileName, String path) throws Exception {
		...
		newFileName += fileExt;
		// newFileName 은 예를 들면, 2023112409291535243254235235234.png 와 같이 된다. 
  ...
  */
	...
	//~~~~~~~~~~~~~~~~~~~~~~~
	public List<Map<String, Object>> parseInsertFileInfo(MailVO mailvo, MultipartHttpServletRequest mrequest, String path) throws Exception {
	...
	//	String newFileName = null;
		String fileName = null; // WAS(톰캣)에 저장될 파일명(2023112409291535243254235235234.png) 
	//	String fileSize = null; // 파일크기 
		
		List<Map<String, Object>> list = new ArrayList<Map<String,Object>>();
		Map<String, Object> listMap = null;
		
	//	int fk_mailId = Integer.parseInt(mailvo.getMailId());
		String mailId = mailvo.getMailId();
